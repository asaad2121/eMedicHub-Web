...
import { PatientFilterDialog } from '../../dialog/patient-filter-dialog/patient-filter-dialog';
import { Patient } from '../../shared/DTO/patient';
import { RouterModule } from '@angular/router';
import { PatientDetailsDialog } from '../../dialog/patient-details-dialog/patient-details-dialog';
...
export class ViewPatients implements OnInit {
  ...
  openPatientDialog(patient: Patient) {
    ...
    const dialogRef = this.dialog.open(PatientDetailsDialog, {
      width: '400px',
      data: formattedData
    });
